      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16">
          ...
          <div className="flex flex-col items-center relative">
            ...
            <h3 className="text-xl font-semibold text-center">STEP 1</h3>
            <p className="text-gray-700">Apply Job</p>
          </div>

          {/* Arrow */}
          <div className="hidden md:block text-teal-500 text-4xl">→</div>

          {/* Step 2 */}
          <div className="flex flex-col items-center relative">
            <div className="w-20 h-20 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 75 75" fill="none">
                <path d="M62.5 12.5H12.5V62.5H62.5V12.5Z" stroke="#12B1BE" strokeWidth="4.16667" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M25 31.25L31.25 25L37.5 31.25L43.75 25L50 31.25" stroke="#12B1BE" strokeWidth="4.16667" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M25 50H50" stroke="#12B1BE" strokeWidth="4.16667" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M25 43.75H50" stroke="#12B1BE" strokeWidth="4.16667" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M25 37.5H50" stroke="#12B1BE" strokeWidth="4.16667" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-center">STEP 2</h3>
          ...
          <div className="flex flex-col items-center">
            <div className="w-20 h-20 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="80" height="75" viewBox="0 0 80 75" fill="none">
                <path d="M29.9142 35.25C36.2807 35.25 41.4417 30.3811 41.4417 24.375C41.4417 18.3689 36.2807 13.5 29.9142 13.5C23.5478 13.5 18.3867 18.3689 18.3867 24.375C18.3867 30.3811 23.5478 35.25 29.9142 35.25Z" stroke="#12B1BE" strokeWidth="4.07812"/>
                <path d="M52.9704 55.6409C52.9704 62.397 52.9704 67.8752 29.9154 67.8752C6.86035 67.8752 6.86035 62.397 6.86035 55.6409C6.86035 48.8848 17.1832 43.4065 29.9154 43.4065C42.6475 43.4065 52.9704 48.8848 52.9704 55.6409Z" stroke="#12B1BE" strokeWidth="4.07812"/>
                <path d="M74.8903 6H51.7217C51.2097 6 50.7186 6.1919 50.3565 6.53348C49.9944 6.87507 49.791 7.33836 49.791 7.82143V22.3929C49.791 22.8759 49.9944 23.3392 50.3565 23.6808C50.7186 24.0224 51.2097 24.2143 51.7217 24.2143H74.8903C75.4024 24.2143 75.8934 24.0224 76.2555 23.6808C76.6176 23.3392 76.821 22.8759 76.821 22.3929V7.82143C76.821 7.33836 76.6176 6.87507 76.2555 6.53348C75.8934 6.1919 75.4024 6 74.8903 6ZM72.7665 7.82143L63.306 13.9961L53.8455 7.82143H72.7665ZM51.7217 22.3929V8.65018L62.7558 15.8539C62.9174 15.9597 63.1093 16.0164 63.306 16.0164C63.5027 16.0164 63.6947 15.9597 63.8563 15.8539L74.8903 8.65018V22.3929H51.7217Z" fill="#12B1BE"/>
              </svg>
            </div>
            <h3 className="text-xl font-semibold text-center">STEP 3</h3>
