  ...
  return (
    <section className="py-16 px-4 max-w-7xl mx-auto bg-white">
      <div className="text-center mb-16">
        ...
        <h3 className="text-2xl text-[#068FA3] font-semibold">HOW WE WORK</h3>
      </div>

      <div className="relative">
        {/* Tree trunk - hidden on mobile */}
        <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-2 h-full bg-[#035C79] rounded-full"></div>
        ...
        <div className="space-y-12 md:space-y-24">
          ...
          <div className="relative flex flex-col md:flex-row md:justify-end">
            <div className="w-full md:w-[45%] md:pr-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#068FA3] font-bold text-xl mr-4 shadow-md">1</div>
            ...
            <div className="hidden md:block absolute left-1/2 top-6 h-1 w-24 bg-[#035C79]"></div>
          </div>

          {/* Item 2 */}
          <div className="relative flex flex-col md:flex-row md:justify-start">
            <div className="w-full md:w-[45%] md:pl-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#035C79] font-bold text-xl mr-4 shadow-md">2</div>
            ...
            <div className="hidden md:block absolute right-1/2 top-6 h-1 w-24 bg-[#035C79]"></div>
          </div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-end">
            <div className="w-full md:w-[45%] md:pr-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#068FA3] font-bold text-xl mr-4 shadow-md">3</div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-start">
            <div className="w-full md:w-[45%] md:pl-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#035C79] font-bold text-xl mr-4 shadow-md">4</div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-end">
            <div className="w-full md:w-[45%] md:pr-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#068FA3] font-bold text-xl mr-4 shadow-md">5</div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-start">
            <div className="w-full md:w-[45%] md:pl-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#035C79] font-bold text-xl mr-4 shadow-md">6</div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-end">
            <div className="w-full md:w-[45%] md:pr-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#068FA3] font-bold text-xl mr-4 shadow-md">7</div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-start">
            <div className="w-full md:w-[45%] md:pl-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#035C79] font-bold text-xl mr-4 shadow-md">8</div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-end">
            <div className="w-full md:w-[45%] md:pr-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#068FA3] font-bold text-xl mr-4 shadow-md">9</div>
          ...
          <div className="relative flex flex-col md:flex-row md:justify-start">
            <div className="w-full md:w-[45%] md:pl-24 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 bg-gradient-to-br from-[#26D6EB] to-[#068FA3]">
              <div className="flex items-center mb-4">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white text-[#035C79] font-bold text-xl mr-4 shadow-md">10</div>
